...
<div id="wrapper">
 ...
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">ADMIN &nbsp; <div class="btn-group pull-right">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/earth1.jpeg" class="user-image img-responsive"/>
					</li>
          <li>
    ...
    <div class="content">
        <!-- <div> -->
            <form action="expensecategory.php" method="POST" enctype="multipart/form-data">
       ...
       <input type="text" name="expense_category_name" id="expense_category_name" class="form-control" placeholder="PLease Enter Expense Name"  required>
              ...
              <div class="form-group col-md-12">
                <label> Enter Amount : </label>
                  <input type="text" name="amount" id="amount"  class="form-control"placeholder="Please Enter amount :"   onBlur="this.value=trim(this.value);" required>
        </div>
       </div>
