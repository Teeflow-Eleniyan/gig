...
// $con = register('localhost', 'root', 'admin', 'iglobe');

//A function to get difference between two numbers
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; color:#FF0">
            <div class="navbar-header" >
                ...
                <a class="navbar-brand" href="index.php">IGLOBE</a> 
            </div>
           <!--  dddddddddd -->
 <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">ADMIN &nbsp; <div class="btn-group pull-right">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/earth3.jpeg" class="user-image img-responsive"/>
					</li>
		...
		echo' <li><a  href="expensecategory.php"><i class="fa fa-cog fa-2x" aria-hidden="true"></i>Create Expense</a></li>';
 ...
 ?>          
             ...
             <li>
                   ...
                   echo' <li>
                   <a href="payroll/index.php"><i class="fa fa-cog fa-2x" aria-hidden="true"></i>Employee Payroll</a>
                   </li>'
                   ?>
